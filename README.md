...
-- =============================================================================
-- NOVO SISTEMA CORRIGIDO DE SELECIONAR JOGADOR (DROPDOWN/LISTA REAL)
-- =============================================================================
...
PlayerListScroll.Parent = Pages["Player"]

local ListLayout = Instance.new("UIListLayout")
ListLayout.Parent = PlayerListScroll
ListLayout.Padding = UDim.new(0, 4)

local SelectBtn = NewButton("Player", "Select Player Target", function()
    ...
    -- Lista os jogadores atuais ativos
    ...
    for _, p in pairs(currentPlayers) do
        if p ~= player then
            ...
            PBtn.MouseButton1Click:Connect(function()
                ...
                Pages["Player"]:FindFirstChild("Select Player Target").Text = "Target: " .. p.DisplayName
                PlayerListScroll.Visible = false
            end)
        end
    end
    ...
    if not addedAny then
        Pages["Player"]:FindFirstChild("Select Player Target").Text = "No other players found"
    end
end)

ListLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
    PlayerListScroll.CanvasSize = UDim2.new(0, 0, 0, ListLayout.AbsoluteContentSize.Y + 5)
end)
